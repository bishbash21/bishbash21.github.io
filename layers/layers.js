...
lyr_redroosterline_17.set('fieldAliases', {'id': 'id', });
...
lyr_redroosterline_17.set('fieldImages', {'id': 'TextEdit', });
...
lyr_redroosterline_17.set('fieldLabels', {'id': 'no label', });
lyr_redroosterline_17.on('precompose', function(evt) {
